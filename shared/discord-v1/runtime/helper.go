...
// HelperClient implements the Helper interface for runtime-side operations.
...
func NewHelperClient(broker *plugin.GRPCBroker, client proto.HelperClient) *HelperClient {
	return &HelperClient{
		broker: broker,
		client: client,
	}
